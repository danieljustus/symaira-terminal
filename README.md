...
**Status: beta (v0.8.3).** Core terminal rendering works; multi-pane,
...
notices (including an Apache-2.0 licensed dependency, `symaira-appkit`) are in
[NOTICE](NOTICE). This app is fully self-contained: it builds and
